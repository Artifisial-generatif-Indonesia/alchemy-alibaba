...
| `RDS.Instance` | Y | Y | Resize/SSL/protect/tags | Y if create identity changes | Y | `DeleteDBInstance` after not-Creating | Alchemy tags | `ClientToken` | Ambiguous create by name | SearchKey/name | Private endpoint wait | Creating/Running; delete rejected while Creating | Ambiguous-create recovery in protocol stack | Y | SSL key material redacted | Subclass + protocol | Not connected | Recycle-bin / permanent RDS destroy not modeled; ENIs after delete |
